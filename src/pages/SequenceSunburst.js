...
const explanationStyle = {
  ...
  /*    d3.text("visit-sequences.csv", function(text) {
    ...
    //   d3.json("https://red3.herokuapp.com/flare", function(error, root) {
      ...
      function updateBreadcrumbs(nodeArray, percentageString) {
        ...
        var g = d3.select("#trail")
            ...
            .data(nodeArray, function(d) { 
              return d.data.name.slice(0,5) + d.depth; });
        ...
        entering.append("svg:polygon")
            ...
            .style("fill", function(d) { return colors((d.children ? d : d.parent).data.name.slice(0,5)); });
        ...
        entering.append("svg:text")
            ...
            .text(function(d) { return d.data.name.slice(0,5); });
